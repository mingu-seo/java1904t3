...
ArrayList<RentalVO> list = (ArrayList)request.getAttribute("list");
				...
				<div class="con">
					...
					<div id="bbs">
						<div id="blist">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="대관 관리목록입니다.">
								<colgroup>
									<col class="w3" />
									<col class="w8" />
									<col class="w8" />
								...
								<thead>
									<tr>
										...
										<th scope="col">연락처</th>
										<th scope="col">희망 전시관</th>
										<th scope="col">대관시작일</th>
										<th scope="col">대관종료일</th>
										<th scope="col">예상가격</th>
										<th scope="col">문의일자</th>
										<th scope="col">첨부파일</th>
										<th scope="col" class="last">답변유무</th>
									</tr>
								</thead>
								<tbody>
								<% if (list.size() == 0) { %>
								...
								%>
									<tr>
										...
										<td <%=targetUrl%>><%=list.get(i).getMember_id()%></td>
										...
										<td <%=targetUrl%>><%=list.get(i).getPrice()%></td>

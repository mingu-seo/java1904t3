									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="프로그램 관리 기본내용입니다.">
										...
										<tbody>
											<tr>
												...
												<td><input type="text" id="instructor" name="instructor" class="w30" title="강사명을 입력해주세요" /></td>
										 	...
										 	<tr>
												...
												<td><input type="text" id="location" name="location" class="w50" title="강의장소을 입력해주세요" /></td>
											...
											<tr>
												...
												<td colspan="1"><input type="text" id="title" name="title" class="w50" title="제목을 입력해주세요" /></td>
										    	<th scope="row"><label for="">프로그램 간략한 시간</label></th>
												<td colspan="3"><input type="text" id="p_time" name="p_time" class="w50" title="프로그램 간략한 정보를 입력해주세요" /></td>
											</tr>
										   	<tr>
									 		...
									 		<tr>
												...
												<td colspan="5"><input type="file" id="imagename_tmp" name="imagename_tmp" class="w50" title="첨부파일을 업로드 해주세요." /></td>
									   		</tr>
									   		<tr>
												<th scope="row"><label for="">내용</label></th>
										      	<td colspan="5"><textarea id="contents" name="contents" title="내용을 입력해주세요" style="width: 100%;"></textarea></td>
											</tr>
                    	       		   	</tbody>
									</table>

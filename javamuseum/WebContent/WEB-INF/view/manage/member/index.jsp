							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="회원 관리목록입니다.">
								...
								%>
									<tr>
										...
										<td <%=targetUrl%>><%=CodeUtil.getGenderName(list.get(i).getGender())%></td>
										...
										<td <%=targetUrl%>><%=DateUtil.getDateFormat(list.get(i).getReg_date())%></td>
										<td <%=targetUrl%>><%=DateUtil.getDateFormat(list.get(i).getMod_date())%></td>
									</tr>
								<%
										}
									 }
